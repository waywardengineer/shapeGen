...
//console.log("parse Header")
	//Probleme mit Zwei Werten f�r eine Variable -> alles durcheinander
...
//Funktion der man einen Layernamen �bergeben kann und die, die Layer_id zur�ckliefert. 
...
function parse_dxf_entities(Data){
	...
	// wenn Type = Polyline -> Unterentities bis SEQEND danach l�schen bis 0 Type
	//0 Type
...
function dxf_group_codes_parse(daten){
	...
	//while (daten.length != 0){
		...
		if (daten[i][0] == "71" ){ //Verkn�pfungspunkt TOP: 1Left 2Center 3Right MIDDLE: 4L 5C 6R Bottom: 7L 8C 9R
